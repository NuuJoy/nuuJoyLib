    ...
    def __init__(self):
        ...
        self.components = [
                           self.button(name='button_A',
                                       respond_area=(0.0,0.7,0.15,1.0),
                                       toggle=False,
                                       color={'normal':{'stroke':(0.259,0.678,0.780,0.5),
                                                        'fill':(0.259,0.678,0.780,0.25),
                                                        'weight':1.0},
                                           'highlight':{'stroke':(0.259,0.678,0.780,1),
                                                        'fill':(0.259,0.678,0.780,0.5),
                                                        'weight':2.0}},
                           ...
                           self.button(name='button_B',
                                       respond_area=(0.15,0.85,0.3,1.0),
                                       toggle=False,
                                       color={'normal':{'stroke':(0.506,0.820,0.322,0.5),
                                                        'fill':(0.506,0.820,0.322,0.25),
                                                        'weight':1.0},
                                           'highlight':{'stroke':(0.506,0.820,0.322,1),
                                                        'fill':(0.506,0.820,0.322,0.5),
                                                        'weight':2.0}},
                                   touchbegan_extfunc=lambda*args:print(args),
                                       touchended_extfunc=lambda*args:print(args),
                                       toggle_on_extfunc=lambda*args:print(args),
                                       toggle_off_extunc=lambda*args:print(args)),
                           self.button(name='button_C',
                           ...
                           self.button(name='button_D',
                                       ...
                                       toggle_on_extfunc=lambda*args:print(args),
                                       toggle_off_extunc=lambda*args:print(args)),
                           self.analog_rect(name='analog_right',
                                            respond_area=(0.5,0.0,1.0,1.0),
                                            max_length=0.25,
                                            color={'normal':{'stroke':(1.000,0.325,0.278,1.0),
                                                             'fill':(1.000,0.325,0.278,0.5),
                                                             'weight':1.0},
                                                'highlight':{'stroke':(1,0,0,1),
                                                             'fill':(1.000,0.325,0.278,0.5),
                                                             'weight':2.0}},
                                            ...
                                            touchended_extfunc=lambda*args:print(args),),
                           self.analog_round(name='analog_left',
                                             respond_area=(0.0,0.0,0.5,1.0),
                                             max_length=0.25,
