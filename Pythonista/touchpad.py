    ...
    def __init__(self,predefine='minimal',stop_event=None):
        ...
        predefined_comp['ds4'] =       [
                                        self.button(name='dpad_y_up',
                                                    label='UP',
                                                    respond_area=(0.1,0.75,0.17,0.87),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                        ...
                                        self.button(name='dpad_y_down',
                                                    label='DN',
                                                    respond_area=(0.1,0.51,0.17,0.63),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                        ...
                                        self.button(name='dpad_x_left',
                                                    label='LEFT',
                                                    respond_area=(0.03,0.63,0.1,0.75),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                        ...
                                        self.button(name='dpad_x_right',
                                                    label='RIGHT',
                                                    respond_area=(0.17,0.63,0.24,0.75),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                        ...
                                        self.button(name='button_cross',
                                                    label='CROSS',
                                                    respond_area=(0.83,0.05,0.9,0.17),
                                                    toggle=None,
                                        ...
                                        self.button(name='button_circle',
                                                    label='CIRCLE',
                                                    respond_area=(0.9,0.17,0.97,0.29),
                                                    toggle=None,
                                        ...
                                        self.button(name='button_square',
                                                    label='SQUARE',
                                                    respond_area=(0.76,0.17,0.83,0.29),
                                                    toggle=None,
                                        ...
                                        self.button(name='button_triangle',
                                                    label='TRIANGLE',
                                                    respond_area=(0.83,0.29,0.9,0.41),
                                                    toggle=None,
                                        ...
                                        self.button(name='button_l1',
                                                    label='L1',
                                                    respond_area=(0.05,0.9,0.15,0.98),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                        ...
                                        self.button(name='button_l2',
                                                    label='L2',
                                                    respond_area=(0.15,0.9,0.25,0.98),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                        ...
                                        self.button(name='button_r1',
                                                    label='R1',
                                                    respond_area=(0.85,0.9,0.95,0.98),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                        ...
                                        self.button(name='button_r2',
                                                    label='R2',
                                                    respond_area=(0.75,0.9,0.85,0.98),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
