...
class touchGamePad(scene.Scene):
    ...
    Example:
        # init touchGamePad class, this come with default ui, you can call joypad.run() even here.
        joypad = touchGamePad()
    ...
    class button():
        def __init__(self,name='default',
            ...
            self.toggle_off_extunc  = toggle_off_extunc
        def is_respond_area(self,touch):
            return ((self.respond_area['x1'] <= (touch.location.x/self.scrnWdth) <= self.respond_area['x2']) and
                    (self.respond_area['y1'] <= (touch.location.y/self.scrnHght) <= self.respond_area['y2']))
        def touch_began(self,touch):
            ...
            if not(self.toggle is None):
                ...
                if self.toggle:
                    ...
                    self.toggle_off_extunc('toggle_off',self.current_state)
        def touch_moved(self,touch):
            pass
        def touch_ended(self,touch):
            self.touch = None
    ...
    def __init__(self,predefine='minimal',stop_event=None):
        super().__init__()
        self.scrnWdth, self.scrnHght = ui.get_screen_size()
        predefined_comp = {'minimal':None,'ds4':None}
        predefined_comp['minimal'] =   [
                                        self.button(name='button_A',
                                                    respond_area=(0.7,0.0,0.85,0.15),
                                                    toggle=False,
                                                    color={'normal':{'stroke':(0.961,0.949,0.388,0.5),
                                                                     'fill':(0.961,0.949,0.388,0.25),
                                                                     'weight':1.0},
                                                        'highlight':{'stroke':(0.961,0.949,0.388,1),
                                                                     'fill':(0.961,0.949,0.388,0.5),
                                                                     'weight':2.0}},
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),
                                                    toggle_on_extfunc=lambda*args:print(args),
                                                    toggle_off_extunc=lambda*args:print(args)),
                                        self.button(name='button_B',
                                                    respond_area=(0.85,0.0,1.0,0.3),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1.000,0.616,0.310,0.5),
                                                                     'fill':(1.000,0.616,0.310,0.25),
                                                                     'weight':1.0},
                                                        'highlight':{'stroke':(1.000,0.616,0.310,1),
                                                                     'fill':(1.000,0.616,0.310,0.5),
                                                                     'weight':2.0}},
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args)),
                                        self.analog_round(name='analog',
                                                          respond_area=(0.0,0.0,1.0,1.0),
                                                          max_length=0.25,
                                                          color={'normal':{'stroke':(0.357,0.302,0.718,1.0),
                                                                           'fill':(0.357,0.302,0.718,0.5),
                                                                           'weight':1.0},
                                                              'highlight':{'stroke':(1,0,0,1),
                                                                           'fill':(0.357,0.302,0.718,0.5),
                                                                           'weight':2.0}},
        ...
        predefined_comp['ds4'] =       [
                                        self.button(name='dpad_y_up',
                                                    label='UP',
                                                    respond_area=(0.12,0.7,0.21,0.84),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                                        'highlight':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,1),
                                                                    'weight':1.0}},
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        self.button(name='dpad_y_down',
                                                    label='DN',
                                                    respond_area=(0.12,0.42,0.21,0.56),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                                    ...
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        self.button(name='dpad_x_left',
                                                    label='LEFT',
                                                    respond_area=(0.03,0.56,0.12,0.70),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                                    ...
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        self.button(name='dpad_x_right',
                                                    label='RIGHT',
                                                    respond_area=(0.21,0.56,0.3,0.70),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                                    ...
                                                    touchended_extfunc=lambda*args:print(args),),
                                        # ------------------------------------------------------- ABXY button
                                        self.button(name='button_cross',
                                                    label='CROSS',
                                                    respond_area=(0.79,0.05,0.88,0.19),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(0,0,1,1),
                                                                    'fill':(0,0,1,0.25),
                                                                    'weight':1.0},
                                                        'highlight':{'stroke':(0,0,1,1),
                                                                    'fill':(0,0,1,1),
                                                                    'weight':1.0}},
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        self.button(name='button_circle',
                                                    label='CIRCLE',
                                                    respond_area=(0.88,0.19,0.97,0.33),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,0,0,1),
                                                                    'fill':(1,0,0,0.25),
                                                                    'weight':1.0},
                                                        'highlight':{'stroke':(1,0,0,1),
                                                                    'fill':(1,0,0,1),
                                                    ...
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        self.button(name='button_square',
                                                    label='SQUARE',
                                                    respond_area=(0.7,0.19,0.79,0.33),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,0,1,1),
                                                                    'fill':(1,0,1,0.25),
                                                                    'weight':1.0},
                                                        'highlight':{'stroke':(1,0,1,1),
                                                                    'fill':(1,0,1,1),
                                                                    'weight':1.0}},
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        self.button(name='button_triangle',
                                                    label='TRIANGLE',
                                                    respond_area=(0.79,0.33,0.88,0.47),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(0,1,1,1),
                                                                    'fill':(0,1,1,0.25),
                                                                    'weight':1.0},
                                                        'highlight':{'stroke':(0,1,1,1),
                                                                    'fill':(0,1,1,1),
                                                                    'weight':1.0}},
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        # ------------------------------------------------------- LR button
                                        self.button(name='button_l1',
                                                    label='L1',
                                                    respond_area=(0.05,0.87,0.15,0.98),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                                    ...
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        self.button(name='button_l2',
                                                    label='L2',
                                                    respond_area=(0.15,0.87,0.25,0.98),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                                    ...
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        self.button(name='button_r1',
                                                    label='R1',
                                                    respond_area=(0.85,0.87,0.95,0.98),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                                    ...
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        self.button(name='button_r2',
                                                    label='R2',
                                                    respond_area=(0.75,0.87,0.85,0.98),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                                    ...
                                                    touchended_extfunc=lambda*args:print(args),),
                                        # ------------------------------------------------------- misc button
                                        self.button(name='button_option',
                                                    label='OPT',
                                                    respond_area=(0.35,0.02,0.45,0.07),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                                    ...
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        self.button(name='button_ps',
                                                    label='PS',
                                                    respond_area=(0.45,0.02,0.55,0.07),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                                    ...
                                                    touchbegan_extfunc=lambda*args:print(args),
                                                    touchended_extfunc=lambda*args:print(args),),
                                        self.button(name='button_share',
                                                    label='SHR',
                                                    respond_area=(0.55,0.02,0.65,0.07),
                                                    toggle=None,
                                                    color={'normal':{'stroke':(1,1,1,1),
                                                                    'fill':(1,1,1,0.25),
                                                                    'weight':1.0},
                                                    ...
                                                    touchended_extfunc=lambda*args:print(args),),
                                        # ------------------------------------------------------- analog
                                        self.analog_round(name='left_analog',
                                                        label='LEFT_ANALOG',
                                                        respond_area=(0.0,0.0,0.5,0.50),
                                                        max_length=0.25,
                                                        color={'normal':{'stroke':(1,1,1,1),
                                                                        'fill':(1,1,1,0.25),
                                                                        'weight':1.0},
                                                        ...
                                                        touchmoved_extfunc=lambda*args:print(args),
                                                        touchended_extfunc=lambda*args:print(args),),
                                        self.analog_round(name='right_analog',
                                                        label='RIGHT_ANALOG',
                                                        respond_area=(0.5,0.43,1.0,0.86),
                                                        max_length=0.25,
                                                        color={'normal':{'stroke':(1,1,1,1),
                                                                        'fill':(1,1,1,0.25),
                                                                        'weight':1.0},
        ...
        self.components = predefined_comp[predefine]
